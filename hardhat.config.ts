...
export default {
  ...
  dependencyCompiler: {
    paths: [
      ...
      "@pollum-io/rex-stake/contracts/stake/StakedREX.sol",
      "@pollum-io/rex-stake/contracts/stake/StakedREXV3.sol",
      "@pollum-io/rex-stake/contracts/proposals/extend-stkaave-distribution/StakedTokenV2Rev3.sol",
    ],
  },
